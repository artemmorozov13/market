      ...
      {isInBasket ? (
        <Box className={styles.basketControls}>
          <Box className={styles.quantityControls}>
            ...
            <Typography className={styles.quantityValue}>{basketItem?.quantity}</Typography>
          ...
          <Typography className={styles.totalPrice}>{formatRubbles(totalPrice)}</Typography>
        </Box>
      ) : (
        <Button
          variant="contained"
