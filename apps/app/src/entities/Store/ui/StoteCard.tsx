...
export const StoreCard: FC<StoreCardProps> = ({ store }) => {
  const defaultImage =
    'https://avatars.mds.yandex.net/get-znatoki-cover/907656/2a0000016ce68780019790803fcc031c1d0b/orig'

  return (
    <Link to={RoutePath.storeById.replace(':storeId', store.id.toString())} className={styles.link}>
