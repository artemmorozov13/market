...
export interface BooleanSelectTypeItemType extends ParentFilterInterface<FilterVariantsEnum.BooleanSelect> {
    label: string
}

export interface MultiSelectItemType extends ParentFilterInterface<FilterVariantsEnum.MultiSelectValue> {
    headerTitle: string
    options: FilterSelectOptionType[]
}

export interface SingleSelectItemType extends ParentFilterInterface<FilterVariantsEnum.SingleSelectValue> {
    options: FilterSelectOptionType[]
}
