...
export const HeaderWithSearch: FC<HeaderWithSearchProps> = observer(() => {
    const { selectedFilterList, isSearchOpen, filterSearchText, setIsSearchOpen, setShowContent, setSelectedFilterList, setFilterSearchText } = filterStore
