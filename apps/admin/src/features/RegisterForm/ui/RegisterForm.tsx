...
import { Alert, Button, CssBaseline, FormControl, Paper, TextField, Typography } from "@mui/material";
                ...
                <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                    <FormControl fullWidth>
                        ...
                        {errors?.shopName?.message && (
                            <Alert severity="error">{errors.shopName.message}</Alert>
                        )}
                    </FormControl>
                    <FormControl fullWidth>
                        <Controller
                    ...
                    <div className={styles.alreadyLoginBlock}>
                        ...
                        <Link to={routeConfig["login"]} className={styles.link}>Войти</Link>
                    </div>
                    <Button
                        type="submit"
                        fullWidth
