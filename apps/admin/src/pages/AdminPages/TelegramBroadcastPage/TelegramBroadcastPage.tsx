      ...
      <Box className={styles.formContainer}>
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          <Typography variant="body1" gutterBottom>
            Этот функционал позволяет отправить сообщение всем пользователям, подключившим Telegram
            бота.
          </Typography>
        ...
        <Dialog open={openConfirmDialog} onClose={handleCancel}>
          ...
          <DialogContent>
            <DialogContentText>
              Вы уверены, что хотите отправить это сообщение всем пользователям? Это действие нельзя
              отменить.
            </DialogContentText>
