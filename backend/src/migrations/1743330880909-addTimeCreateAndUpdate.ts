...
export class AddTimeCreateAndUpdate1743330880909 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "delivery_time" ("id" SERIAL NOT NULL, "startTime" TIME NOT NULL, "endTime" TIME NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "pickupPointId" integer, CONSTRAINT "PK_ef1b3d23f93ec33cfa77e3bb08d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "delivery_time" ADD CONSTRAINT "FK_e440fca8c08264e26b41a8aa42d" FOREIGN KEY ("pickupPointId") REFERENCES "pickup_point"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
